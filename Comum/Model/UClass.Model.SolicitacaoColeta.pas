...
begin
   ...
   FLogEndereco := aJSON.GetValue('LogEndereco').Value;
   FLogBairro := aJSON.GetValue('LogBairro').Value;
end;
...
begin
   ...
   Result.AddPair('LogEndereco',FLogEndereco);
   Result.AddPair('LogBairro',FLogBairro);
end;
