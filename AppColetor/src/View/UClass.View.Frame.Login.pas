      ...
      begin
         try
            ...
            TThread.Synchronize(TThread.CurrentThread,
               procedure
               begin
                  if FTipoUsu = ttuReciclador then
...
begin
   LfrmCriarConta := TfrmCriarConta.Create(nil);
   LfrmCriarConta.TipoUsu := FTipoUsu;
   TMainScreen.GetInstance.Show<TfrmCriarConta>(LfrmCriarConta);
end;
